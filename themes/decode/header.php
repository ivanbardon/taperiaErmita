...
<link rel="apple-touch-icon" sizes="180x180" href="/wp-content/uploads/2016/12/touch-icon-iphone-retina.png">
<link rel="apple-touch-icon" sizes="167x167" href="/wp-content/uploads/2016/12/touch-icon-ipad-retina.png">
<meta name="apple-mobile-web-app-status-bar-style" content="translucent">
<meta name="apple-mobile-web-app-title" content="La Tapería">
...
<div id="page" class="hfeed site">
	...
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'decode' ); ?></a>
		...
		<?php function decode_create_sidebar_link() {
			...
			<nav class="navbar-fixed-top" id="nav_pal">
				<div class="container">
					<button id="sidebar-link" class="sidebar-link SidebarLink <?php echo get_theme_mod( 'sidebar_button_position');?>" title="<?php esc_attr_e( 'Show sidebar', 'decode' )?>">
				...
				<div class="nav_info" id="nav_info_sec">
